...
// ------------------ FETCH BY TAG ------------------
export const fetchDataByTag = async (tag?: string): Promise<ServiceResponse<Recipe[]>> => {
...
export const deleteDataById = async (id: string): Promise<void> => {
  const params = {
    TableName: 'Recepies',
    Key: { id },
  }
...
// ------------------ FETCH LAST X ------------------
export const fetchLastXData = async (count: number): Promise<ServiceResponse<Recipe[]>> => {
...
// ------------------ FETCH BY ID ------------------
export const fetchDataById = async (id: string): Promise<ServiceResponse<Recipe>> => {
